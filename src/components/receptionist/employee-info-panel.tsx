    ...
    <div className="bg-white rounded-2xl shadow-xl border border-neutral-100 p-6 space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="space-y-1.5">
          <label className="text-sm font-bold text-neutral-700">Họ tên</label>
          <input
            type="text"
            readOnly
        ...
        {/* Employee Code */}
        <div className="space-y-1.5">
          <label className="text-sm font-bold text-neutral-700">Mã nhân viên</label>
          <input
            type="text"
            readOnly
        ...
        {/* Job Title / Role */}
        <div className="space-y-1.5">
          <label className="text-sm font-bold text-neutral-700">Chức vụ</label>
          <input
            type="text"
            readOnly
